...
public class GlobalExceptionAdvice {
    ...
    protected NetplixApiResponse<?> handleUnreadable(HttpMessageNotReadableException e) {
        log.warn("unreadable request: {}", e.getMessage());
        return NetplixApiResponse.fail(ErrorCode.DEFAULT_ERROR, "요청 형식이 올바르지 않습니다.");
    }
